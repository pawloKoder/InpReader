...
const std::string Keywords::Static::keyName = "Static";


Keywords::Static::Static(Keywords::Keyword* parent): Keyword(parent)
{}


Keywords::Keyword* Keywords::Static::appendDataLine(const Tokens::DataLine * line)
{
